...
const events = [
  { cat: 'Panel', title: 'Samvidhan Panel', status: 'upcoming', desc: 'A dialogue-focused panel initiative designed to encourage reflective conversation on current topics and pressing issues. Open to all students.', date: 'Date TBA' },
